...
const NAV_ITEMS = [
  ...
  { id: "attendance", label: "Attendance", path: "/attendance", icon: ClipboardList },
              ...
              return (
                <li key={item.id} style={{ marginBottom: 8 }}>
                  <NavLink
                    ...
                    onMouseEnter={(e) => { if (!e.currentTarget.classList.contains('active')) e.currentTarget.style.background = "rgba(0,0,0,0.15)"; }}
