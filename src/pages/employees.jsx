...
export default function Employees() {
  ...
  const handleSave = async () => {
    if (
      ...
      setError("Employee ID, Name, Email, and Department are required");
      return;
    }
    try {
    ...
    <div style={{ backgroundColor: "#f3f4f6", minHeight: "100%" }}>
      ...
      >
        <div>
          ...
          <p style={{ marginTop: "6px", fontSize: "16px", opacity: 0.85 }}>
              ...
              <tbody>
                {filteredEmployees.map((emp, index) => (
                  <tr key={emp._id} style={{ textAlign: "center" }}>
                    ...
                    <td style={tdStyle}>
                      {emp.departmentName || getDepartmentName(emp.department)}
                    </td>
                    ...
                    <td style={{ ...tdStyle, whiteSpace: "nowrap" }}>
                      <button
                        ...
                        style={{ ...actionBtn, background: "#3f3d9c" }}
                      >
                        View
                      </button>
                      <button
                        onClick={() => {
                          setFormData({ ...emptyForm, ...emp, password: "" });
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  >
                    {viewEmployee.designation || "No designation"}
                  </p>
                  <span
                    style={{
                      fontSize: 11,
                ...
                {[
                  ...
                  { label: "Email", value: viewEmployee.email },
                  {
                    ...
                    value:
                      ...
                      getDepartmentName(viewEmployee.department),
                  },
                  {
                    label: "Salary",
                    value: viewEmployee.salary
                      ? `$${Number(viewEmployee.salary).toLocaleString()}`
                      : "-",
                  },
                  { label: "Gender", value: viewEmployee.gender || "-" },
                  {
                    label: "Marital Status",
                    value: viewEmployee.marital || "-",
                  },
                  {
                    label: "Date of Birth",
                    value: viewEmployee.dob
                      ? new Date(viewEmployee.dob).toLocaleDateString()
                      : "-",
                  },
                ].map(({ label, value }) => (
                  <div
